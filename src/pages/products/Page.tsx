...
export default function Products() {
  ...
  useEffect(()=>{
    const fetchRepos = async () => {
        ...
        let products = results.reduce((prev:Record<string,Repo>,curr: Repo)=>{
          let newData = prev;
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className={`inline-block px-4 py-2 text-black rotate-2 ${statusColor}`}>
              <span className="font-mono text-xl font-bold">Status: {repo.status}</span>
            </div>
          ...
          <div className="relative hidden md:block">
            ...
            <div className="min-h-[350px] relative bg-black dark:bg-white border-4 border-black dark:border-white p-8 rotate-1">
              <img src="/minimalist-software-interface-screenshot-with-code.jpg" alt="Product Screenshot" className="w-full h-auto" />
            </div>
