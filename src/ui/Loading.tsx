  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="w-20 h-20 border-4 border-black dark:border-white animate-[spin_3s_linear_infinite]">
          {/* Inner counter-rotating square */}
          <div className="w-full h-full border-4 border-black dark:border-white flex items-center justify-center animate-[spin_2s_linear_infinite_reverse]">
            {/* Center square */}
      ...
      {/* Progress bar */}
      <div className="mt-4 w-40 h-2 border-2 border-black dark:border-white overflow-hidden">
